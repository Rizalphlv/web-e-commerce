        ...
        <div class="card-body p-5">
          ...
          <form action="<?= base_url('auth') ?>" method="post">
            <h6 class="row">
              ...
              <h6 class="col-md-12">
                <h6 class="d-flex my-2 justify-content-between">
                  <div class="d-inline-block mr-3">


                  </div>
                  <h6><a class="text-blue" href="#">Forgot Your Password?</a></h6>
                </h6>
                <button type="submit" class="btn btn-lg btn-primary btn-block mb-4">Sign In</button>
                <p>Don't have an account yet ?
                  <a class="text-blue" href="<?= base_url('auth/registration'); ?>">Sign Up</a>
                </p>
              </h6>
        </div>
        </form>
